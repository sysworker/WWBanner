...
//
//  WWBannerOverLayout.m
//  WWBanner
//
//  Created by WW on 2019/12/18.
//  Copyright © 2019 WW. All rights reserved.
//
#import "WWBannerOverLayout.h"
@interface WWBannerOverLayout()
...
@end
@implementation WWBannerOverLayout
...
- (void)prepareLayout
{
    ...
    if (self.param.wCardSize.width&&self.param.wCardSize.height) {
        self.itemSize = self.param.wCardSize;
    }
