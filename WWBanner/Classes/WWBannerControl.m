...
@end
@implementation WWBannerControl
...
//            rect.origin.x = (self.param.wFrame.size.width - rect.size.width)/2;
    ...
    if (self.param.wBannerControlPosition == BannerControlBotton) {
        CGRect rect = self.frame;
        rect.origin.y = self.param.wFrame.size.height;
        self.frame = rect;
    }
    
    
    if (self.param.wBannerControlBottomOff) {
        CGRect rect = self.frame;
        rect.origin.y = rect.origin.y - self.param.wBannerControlBottomOff;
        self.frame = rect;
    }
